    ...
    flutterLocalNotificationsPlugin.initialize(initializationSettings,
      ...
      if (payload != null) {
        ...
        if (pay[0] == "products") {
          ...
          Navigator.push(
              context, (CupertinoPageRoute(builder: (context) => MyWallet())));
        } else if (pay[0] == 'order') {
          Navigator.push(
              context, (CupertinoPageRoute(builder: (context) => MyOrder())));
          ...
          Navigator.push(context,
              CupertinoPageRoute(builder: (context) => CustomerSupport()));
        } else {
          Navigator.push(
            context,
