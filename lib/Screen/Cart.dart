// ignore_for_file: implementation_imports, unrelated_type_equality_checks, unused_local_variable
...
class StateCart extends State<Cart> with TickerProviderStateMixin {
  ...
  varientLoop(int index) {
    // List<Product> cartOffList = context.read<CartOffProvider>().cartList;
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                          ...
                                          .read<CartProvider>()
                                          .removeCartItem(
                                              cartOffList[index].productList![0]);*/
                                            /* */
                                            //cartOffList[index].qty = "0";
  ...
  saveForLaterFun(int index, int selectedPos, double total) async {
    ...
    if (saveLaterOffList.length > 0) {
      var extPro = saveLaterOffList
  ...
  cartFun(int index, int selectedPos, double total) async {
    ...
    oriPrice = oriPrice + total;
    if (cartOffList.length > 0) {
      var extPro = cartOffList
  ...
  _showContent1(BuildContext context) {
    return _isCartLoad || _isSaveLoad
        ? shimmer(context)
        : cartOffList.length == 0 && saveLaterOffList.length == 0
            ? cartEmpty()
            : Container(
