...
class StateItem extends State<ProductDetail> with TickerProviderStateMixin {
  ...
  bool /*notificationisloadmore1 = true,*/
      notificationisgettingdata1 = false,
  ...
  void initState() {
    ...
    if (widget.model!.otherImage != "" && widget.model!.otherImage!.length > 0)
  ...
  onSelectFun(bool selected, int index, int i) {
    setState(() async {
      if (selected) if (mounted) available = false;
  ...
  _showContent() {
    return Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
                ...
                Container(
                    ...
                    child: NotificationListener<ScrollNotification>(
                        onNotification: (ScrollNotification scrollInfo) {
                          print(
                              "pixels***${scrollInfo.metrics.pixels}***${scrollInfo.metrics.maxScrollExtent}");
      ...
      available == true || outOfStock == false
          ? Container(
              height: 55,
              decoration: BoxDecoration(
    ...
    if (_isNetworkAvail) {
      try {
        ...
        if (!error) {
          ...
          print(
              "offset****${context.read<ProductDetailProvider>().offset}***total***${context.read<ProductDetailProvider>().total}");
          if (context.read<ProductDetailProvider>().offset <
            ...
            if (mainlist.length != 0) {
              ...
              items.addAll(
                  mainlist.map((data) => new Product.fromJson(data)).toList());
              ...
              context.read<ProductDetailProvider>().setProductList(allitems);
              /*  context
                    .read<ProductDetailProvider>()
                    .setProNotiLoading(true);*/
